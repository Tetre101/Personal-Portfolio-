    ...
    return (
        <div className="home__data">
            ...
            <p className="home__description">
                Solutiondriven Front and Back End Developer adept at contributing to highly collaborative work environment, finding solutions and determining customer satisfaction.
            </p>
